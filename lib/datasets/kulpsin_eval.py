"""
I edited voc_eval.py to function with KulpsinAnnotations.
"""
...
def kulpsin_eval(detpath,
    ...
    for imagename in imagenames:
        imdata = annotations.load_image_data(image_id=imagename)
        bbox = np.array([[
            _box['pt1'][0],
            _box['pt1'][1],
            _box['pt2'][0],
            _box['pt2'][1],
        ] for _box in imdata['bounding_boxes'] if _box['entity'] == classname])
